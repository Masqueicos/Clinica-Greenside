...
app.get('/', (req, res) => {
  if (req.session.loggedin) {
    ...
    res.send('Faça login para acessar esta página. <a href="pages/log-in">Login</a>');
  }
});
...
app.get('/pages/log-in', (req, res) => { // Rota da página 'login.ejs'
...
app.get('/planos', (req, res) => { // Rota da página 'planos.ejs'
  res.render('pages/planos.ejs');
});

app.get('/contato', (req, res) => {
  res.render('pages/contato.ejs'); // Certifique-se de que 'contato' corresponda ao nome do seu arquivo ejs.
});

app.get('/pagamento', (req, res) => {
  res.render('pages/pagamento.ejs'); // Certifique-se de que 'payment' corresponda ao nome do seu arquivo ejs.
});
